...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MaterialTextView tvTitle = view.findViewById(R.id.tvTitle);
        MaterialTextView tvCustomSettings = view.findViewById(R.id.tvCustomSettings);
        MaterialTextView tvEnablePush = view.findViewById(R.id.tvEnablePush);

        tvTitle.setText(util.setText("settings", getContext().getString(R.string.settings)));
        tvCustomSettings.setText(util.setText("custom_settings", getContext().getString(R.string.custom_settings)));
        tvEnablePush.setText(util.setText("enable_push_notification", getContext().getString(R.string.enable_push_notification)));
