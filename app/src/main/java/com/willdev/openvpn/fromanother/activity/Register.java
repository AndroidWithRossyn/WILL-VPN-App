...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialTextView tvHaveAccount = findViewById(R.id.tvHaveAccount);
        ...
        editText_name.setHint(util.setText("enter_name", getString(R.string.enter_name)));
        ...
        editText_phoneNo.setHint(util.setText("enter_phone_number", getString(R.string.enter_phone_number)));
        editText_reference.setHint(util.setText("enter_reference_code", getString(R.string.enter_reference_code)));
        tvHaveAccount.setText(util.setText("already_have_an_account", getString(R.string.already_have_an_account)));
        textView_login.setText(util.setText("login_text", getString(R.string.login_text)));
