...
public class EarnPoint extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle(util.setText("earn_point", getString(R.string.earn_point)));
        ...
        if (method.isNetworkAvailable()) {
            ...
            method.alertBox(util.setText("no_internet_connection", getString(R.string.no_internet_connection)));
        }
