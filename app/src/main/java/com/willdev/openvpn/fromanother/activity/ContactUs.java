...
public class ContactUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(util.setText("contact_us", getResources().getString(R.string.contact_us)));
        ...
        MaterialTextView tvContactDetail = findViewById(R.id.tvContactDetail);
        TextInputLayout tvName = findViewById(R.id.tvName);
        TextInputLayout tvEmail = findViewById(R.id.tvEmail);
        TextInputLayout tvMessage = findViewById(R.id.tvMessage);
        MaterialTextView textView_subject_contact_us = findViewById(R.id.textView_subject_contact_us);

        tvContactDetail.setText(util.setText("contact_detail", getString(R.string.contact_detail)));
        tvEmail.setHint(util.setText("please_enter_email", getString(R.string.please_enter_email)));
        tvName.setHint(util.setText("please_enter_name", getString(R.string.please_enter_name)));
        tvMessage.setHint(util.setText("please_enter_message", getString(R.string.please_enter_message)));
        textView_subject_contact_us.setText(util.setText("subject", getString(R.string.subject)));
        ...
        button_submit.setText(util.setText("submit", getString(R.string.submit)));
    ...
    public void getContact(String userId) {
        ...
        client.post(Constant.url, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (jsonObject.has(Constant.STATUS)) {
                        ...
                        contactLists.add(0, new ContactList("", util.setText("select_contact_type", getResources().getString(R.string.select_contact_type))));
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                progressDialog.dismiss();
                textViewNoData.setVisibility(View.VISIBLE);
                method.alertBox(new Util().setText("failed_try_again", getString(R.string.failed_try_again)));
            }
        });
