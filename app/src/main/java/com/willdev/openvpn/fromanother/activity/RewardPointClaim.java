...
public class RewardPointClaim extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(util.setText("payment_detail", "Payment Detail"));
        ...
        MaterialTextView tvMsg = findViewById(R.id.tvMsg);
        MaterialTextView textView_noData_reward_point_claim = findViewById(R.id.textView_noData_reward_point_claim);
        TextInputLayout tilPaymentDetail = findViewById(R.id.tilPaymentDetail);

        tvMsg.setText(util.setText("bank_detail", getString(R.string.bank_detail)));
        tilPaymentDetail.setHint(util.setText("payment_detail", "Payment Detail"));
        textView_noData_reward_point_claim.setText(util.setText("no_data_found", "No Data Found"));
        buttonSubmit.setText(util.setText("submit", getString(R.string.submit)));
