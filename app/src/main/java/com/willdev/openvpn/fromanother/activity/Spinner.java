...
public class Spinner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(util.setText("lucky_wheel", "Lucky Wheel"));
        ...
        textView_noData.setText(util.setText("no_data_found", "No Data Found"));
        button_spinner.setText(util.setText("play", "Play"));
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (jsonObject.has(Constant.STATUS)) {
                        ...
                        String msg_one = util.setText("daily_total_spins", getResources().getString(R.string.daily_total_spins));
                        String msg_two = util.setText("remaining_spins_today", getResources().getString(R.string.remaining_spins_today));
                ...
                try {
                    ...
                    if (jsonObject.has(Constant.STATUS)) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            method.alertBox(util.setText("spinner_success",
                                    getString(R.string.spinner_success)) + " " + msg + " " + util.setText("point", getString(R.string.point)) + "!");
