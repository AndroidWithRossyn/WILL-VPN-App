...
public class RewardPointAdapter extends RecyclerView.Adapter<RewardPointAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.tvPoint.setText(util.setText("point", "Points"));
        ...
        if (rewardPointLists.get(position).getTitle().equals("")) {
            ...
            holder.textView_title.setText(util.setText(rewardPointLists.get(position).getActivity_type(), rewardPointLists.get(position).getActivity_type()));
            holder.textView_type.setText(util.setText(rewardPointLists.get(position).getActivity_type(), rewardPointLists.get(position).getActivity_type()));

        } else {

            Glide.with(activity).load(rewardPointLists.get(position).getStatus_thumbnail())
                    .placeholder(R.drawable.logo).into(holder.imageView);
            holder.textView_title.setText(util.setText(rewardPointLists.get(position).getTitle(), rewardPointLists.get(position).getTitle()));
            holder.textView_type.setText(util.setText(rewardPointLists.get(position).getActivity_type(), rewardPointLists.get(position).getActivity_type()));
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private MaterialTextView textView_title, textView_date, textView_time, textView_type, textView_point, tvPoint;
