...
import static com.willdev.openvpn.fromanother.util.util.Constant.showLangOnFirstOpen;
...
//        }
    ...
    private void launchHomeScreen() {
        ...
        //Change showLangOnFirstOpen in Constants
        if (showLangOnFirstOpen) {
            startActivity(new Intent(WelcomeActivity.this, LanguageActivity.class));
            finish();
        } else {

            //So login wont show again when skipped the first time
