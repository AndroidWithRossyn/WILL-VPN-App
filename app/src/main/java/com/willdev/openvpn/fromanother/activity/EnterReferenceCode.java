...
public class EnterReferenceCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(util.setText("reference_code", "Reference Code"));
        ...
        MaterialTextView tvEnterReferenceCode = findViewById(R.id.tvEnterReferenceCode);
        MaterialTextView tvEnterReferenceCodeMsg = findViewById(R.id.tvEnterReferenceCodeMsg);
        TextInputLayout tilEnterReferenceCode = findViewById(R.id.tilEnterReferenceCode);

        tvEnterReferenceCode.setText(util.setText("enter_reference_code", "Enter Reference Code"));
        tvEnterReferenceCodeMsg.setText(util.setText("enter_reference_code_msg", "Enter your friend's reference code to earn more points"));
        tilEnterReferenceCode.setHint(util.setText("enter_reference_code", "Enter Reference Code"));
        button_continue.setText(util.setText("btn_continue", "Continue"));
        button_skip.setText(util.setText("skip", "Skip"));
