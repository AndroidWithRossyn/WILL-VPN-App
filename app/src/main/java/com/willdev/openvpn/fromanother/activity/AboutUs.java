...
public class AboutUs extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle(util.setText("about_us", getResources().getString(R.string.about_us)));
        ...
        MaterialTextView tvAboutUsVersion = findViewById(R.id.tvAboutUsVersion);
        MaterialTextView tvCompany = findViewById(R.id.tvCompany);
        MaterialTextView tvEmail = findViewById(R.id.tvEmail);
        MaterialTextView tvWebsite = findViewById(R.id.tvWebsite);
        MaterialTextView tvContact = findViewById(R.id.tvContact);
        MaterialTextView tvAbout = findViewById(R.id.tvAbout);

        tvAboutUsVersion.setText(util.setText("about_us_version", getString(R.string.about_us_version)));
        tvCompany.setText(util.setText("about_us_company", getString(R.string.about_us_company)));
        tvEmail.setText(util.setText("about_us_email", getString(R.string.about_us_email)));
        tvWebsite.setText(util.setText("about_us_website", getString(R.string.about_us_website)));
        tvContact.setText(util.setText("about_us_contact", getString(R.string.about_us_contact)));
        tvAbout.setText(util.setText("about_us_about", getString(R.string.about_us_about)));
        textViewNoData.setText(util.setText("no_data_found", getResources().getString(R.string.no_data_found)));
