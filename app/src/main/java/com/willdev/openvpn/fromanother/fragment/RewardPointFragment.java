...
public class RewardPointFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MaterialTextView tvYouHave = view.findViewById(R.id.tvYouHave);
        MaterialTextView tvRewardPoint = view.findViewById(R.id.tvRewardPoint);

        tvTitle.setText(util.setText("reward", getString(R.string.reward)));
        tvYouHave.setText(util.setText("you_have", getString(R.string.you_have)));
        tvRewardPoint.setText(util.setText("reward_point", getString(R.string.reward_point)));
        button.setText(util.setText("reward_point_claim", getString(R.string.reward_point_claim)));
        ...
        String[] tabName = {util.setText("current_point", getResources().getString(R.string.current_point)),
                util.setText("withdrawal_history", getResources().getString(R.string.withdrawal_history))};
                            ...
                            if (jsonObject.has(Constant.STATUS)) {
                                ...
                                if (success.equals("1")) {
                                    ...
                                    String money = redeem_points
                                            + " " + util.setText("point", getResources().getString(R.string.point))
