...
public class SharedPreference {
    ...
    private static final String WORDS_JSON = "WORDS_JSON";
    ...
    public void saveWords(String wordsJson, String direction){
        mPrefEditor.putString(WORDS_JSON, wordsJson);
        mPrefEditor.putString(DIRECTION, direction);
        mPrefEditor.commit();
    }

    public String getWords(){
        return mPreference.getString(WORDS_JSON,"");
    }

    public String getDirection(){
        return mPreference.getString(DIRECTION,"");
    }
